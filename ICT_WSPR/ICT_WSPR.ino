...
/*
   HABalloon by KD2NDR
   Improvements by YO3ICT
   Improvements By SA6BSS
   You may use and modify the following code to suit your needs so long as it remains open source and it is for non-commercial use only.
*/
