...
As can be seeen in the below picture the solar cells is intended to be soldered to the board with a center copper rod of 0,8mm, notice, there are two pairs of vias,   
one is GND and one pair is not connected to anything which is where you solder the center support for the cells - see below pic  
